                                ...
                                <form class="forms-sample" action="{{ url('admin_profile/update') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" 
                                            placeholder="Email" name="email" value="{{ $getRecord->email }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" 
                                             placeholder="Address" name="address" value="{{ $getRecord->address }}">
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label class="form-label">About</label>
                                        <textarea type="text" class="form-control" 
                                             placeholder="About" name="about" value="{{ $getRecord->about }}"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label  class="form-label">Website</label>
                                        <input type="text" class="form-control" 
                                             placeholder="Website" name="website" value="{{ $getRecord->website }}">
                                    </div>
